    ...
    <div class="container mx-auto px-4 sm:px-6 md:px-8 lg:px-12 my-8">
        <div class="border border-gray-300 rounded bg-white shadow-sm overflow-hidden">
            <div class="p-4 border border-gray-300 bg-gray-50 text-center">
                <h1 class="m-0 text-2xl font-semibold text-gray-800 ">Mission:</h1>
            </div>
            <div class="px-6 py-5 ">
                <p class="mb-6 text-md leading-relaxed text-gray-800">
                ...
                <h2 class="mb-2 text-xl font-semibold text-gray-800 text-center">Vision:</h2>
                <p class="mb-6 text-md leading-relaxed text-gray-800">
                ...
                <h2 class="mb-2 text-xl font-semibold text-gray-800 text-center">Values:</h2>
                <p class="mb-6 text-md leading-relaxed text-gray-800">
                ...
                <h2 class="mb-4 text-xl font-semibold text-gray-800 text-center">Our Objects:</h2>
                <div class="text-left ">
                    <p class="mb-2 text-md leading-relaxed text-gray-800">
